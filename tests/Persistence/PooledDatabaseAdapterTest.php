...
final class PooledDatabaseAdapterTest extends TestCase
{
    ...
    {
        // Exercises a REAL sqlite connection; skip rather than report an
        // error that says nothing about the code under test. CI installs
        // pdo_sqlite, so this genuinely runs there.
