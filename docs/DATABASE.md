# Database Plugin — Multi-Driver Persistence
...
(per [Repository layer](https://github.com/AlfaCode-Team/hkm-kernel/blob/main/docs/guides/05_REPOSITORY.md)).
...
fake (see [Testing](https://github.com/AlfaCode-Team/hkm-kernel/blob/main/docs/guides/10_TESTING.md)).
...
[Data-access blueprint](https://github.com/AlfaCode-Team/hkm-kernel/blob/main/docs/guides/22_DATA_ACCESS_ORM_BLUEPRINT.md).
...
- [Repository layer](https://github.com/AlfaCode-Team/hkm-kernel/blob/main/docs/guides/05_REPOSITORY.md) — repository layer rules (DatabasePort only)
- [Migrations](https://github.com/AlfaCode-Team/hkm-kernel/blob/main/docs/guides/18_MIGRATIONS.md) — LetMigrate uses the same `DB_*` variables
- [Plugin convention](https://github.com/AlfaCode-Team/hkm-kernel/blob/main/docs/guides/16_PLUGINS.md) — plugins folder convention
- [Testing](https://github.com/AlfaCode-Team/hkm-kernel/blob/main/docs/guides/10_TESTING.md) — port fakes and service tests
```
