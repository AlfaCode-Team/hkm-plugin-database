...
### Code
- 📁 [Module Source](../../) — All implementation files
- 🔧 [Provider](../../Provider.php) — DI registration
- 🗄️ [Database Adapter](../../Infrastructure/Persistence/MultiDriverDatabaseAdapter.php) — DatabasePort implementation
...
- Check error message in [ConnectionException](../../Exceptions/ConnectionException.php)
